...
describe('RecipesService', () => {
    ...
    describe('getRecipeById', () => {
        it('should return recipe by ID', async () => {
            ...
            expect(recipeRepository.getRecipeById).toHaveBeenCalledWith(
                recipeId
            )
        })
    ...
    describe('listAllRecipes', () => {
        it('should return all recipes with pagination info', async () => {
            ...
            recipeRepository.listAllRecipes = jest
                .fn()
            ...
            expect(recipeRepository.listAllRecipes).toHaveBeenCalledWith(
                filters
            )
