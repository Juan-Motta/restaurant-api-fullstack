...
import { createOrderController, listAllOrdersController, getOrderController } from '../../../../../src/infraestructure/adapters/input/api/orders';
import { getOrderService, getAuthService } from '../../../../../src/infraestructure/dependencies/services';
...
describe('Order Controllers', () => {
    ...
    describe('createOrderController', () => {
        it('should create an order successfully', async () => {
            ...
            const mockOrderService = {
                createOrder: jest.fn().mockResolvedValue({ id: 1, status: 'PREPARING' }),
            };
            ...
            expect(res.end).toHaveBeenCalledWith(JSON.stringify({ id: 1, status: 'PREPARING' }));
        });
    });
    ...
    describe('listAllOrdersController', () => {
        it('should list all orders successfully', async () => {
            ...
            const mockOrderService = {
                listAllOrders: jest.fn().mockResolvedValue({ data: [], page: 1, perPage: 10, total: 0 }),
            };
            ...
            expect(db.connect).toHaveBeenCalled();
            expect(mockAuthService.verifyHeader).toHaveBeenCalledWith(req);
            expect(OrderFilterValidator.validate).toHaveBeenCalledWith(req.query);
            expect(getOrderService).toHaveBeenCalledWith(mockClient);
    ...
    describe('getOrderController', () => {
        it('should get order by ID successfully', async () => {
            ...
            const mockOrderService = {
                getOrderById: jest.fn().mockResolvedValue({ id: 1, status: 'PREPARING' }),
            };
