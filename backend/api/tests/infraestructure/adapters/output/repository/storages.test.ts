...
describe('StorageRepository', () => {
    ...
    describe('countAll', () => {
        it('should return the count of all ingredients', async () => {
            ...
            expect(client.query).toHaveBeenCalledWith('SELECT COUNT(*) FROM ingredients');
        });
    });
    ...
    describe('getAllIngredients', () => {
        it('should return all ingredients based on filters', async () => {
            ...
            const mockQueryResult = {
                rows: [
                    { ingredientid: '1', ingredientname: 'Sugar', ingredientquantity: 100 },
                    { ingredientid: '2', ingredientname: 'Salt', ingredientquantity: 50 },
                ],
            };
        ...
        it('should build the correct SQL query with filters', async () => {
            ...
            expect(client.query).toHaveBeenCalledWith(
                ...
                [filters.ingredientId, `%${filters.ingredientName}%`, filters.perPage, 0]
            );
        });
