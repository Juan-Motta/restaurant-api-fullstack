...
import { getUserRepository, getOrderRepository, getRecipeRepository, getStorageRespository, getBuysRepository, getEventsLogsRepository } from '../../../src/infraestructure/dependencies/repositories';
import { getJwtManager, getPasswordManager, getRabbitMQProducer } from '../../../src/infraestructure/dependencies/utils';
