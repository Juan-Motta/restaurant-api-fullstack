...
describe('StorageService', () => {
        ...
        it('should handle errors when notifying kitchen', async () => {
            ...
            expect(eventsLogsRepository.create).toHaveBeenCalledWith(
                ...
                expect.stringContaining(
                    'Error notifying to kitchen: Error: RabbitMQ error'
                )
            )
        })
    })
    ...
    describe('prepareIngredients', () => {
        it('should prepare ingredients for the order', async () => {
            ...
            recipeRepository.getRecipeIngredientsNeeded = jest
                .fn()
                .mockResolvedValue([
                    {
                        ingredientId: 1,
            ...
            const buyIngredientSpy = jest
                .spyOn(storageService, 'buyIngredient')
                .mockResolvedValue(undefined)
            const notifyToKitchenSpy = jest
                .spyOn(storageService, 'notifyToKitchen')
                .mockResolvedValue(undefined)
            ...
            expect(
                recipeRepository.getRecipeIngredientsNeeded
